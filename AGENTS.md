...
| Signals → Linear | [quality-loops](./SOPs/quality-loops.md); PostHog bets [product-signal-intake](./SOPs/product-signal-intake.md); Sonar [sonarqube-findings](./SOPs/sonarqube-findings.md) |
