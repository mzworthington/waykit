...
| CI / telemetry → Linear ([quality-loops](../../SOPs/quality-loops.md)) | File typed tickets (scout: one source, no PR), hygiene, then work picker. Read [lists/work-picker-allowlist.yaml](../../lists/work-picker-allowlist.yaml). `agent-debug` for Bug. Draft PR only. No new specialist. Cloud dashboard catalog missing → **BLOCKED**. |
...
| [SOPs/quality-loops.md](../../SOPs/quality-loops.md) | CI / RUM / scout → Linear → draft PR |
