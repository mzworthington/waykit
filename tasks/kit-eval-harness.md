...
| 11 | “Observe coding-agent tokens, cost, and traces in SigNoz” | `agent-telemetry` + [coding-agent-observability](../SOPs/coding-agent-observability.md) (`wk mcp signoz --install`); not PostHog; no `agent-signoz` | EVAL-ROUTE-055 |
